...
### Toolbar (Save, Export to .BPMN, Undo, Redo, Create Process Instance)

The toolbar at the top of the editor provides several actions you can perform on your process model:

<div className="flex flex-row gap-2 items-center">- <Save />**Save**: Save the current process model.</div>
<div className="flex flex-row gap-2 items-center">- <FileDown />**Export to .BPMN**: Export the current process model as a BPMN 2.0 XML file.</div>
