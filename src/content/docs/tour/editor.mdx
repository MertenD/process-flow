...
<ul>
    <li><div className="flex flex-row gap-2 items-center"><Save /><div>**Save**: Save the current process model.</div></div></li>
    <li><div className="flex flex-row gap-2 items-center"><FileDown /><div>**Export to .BPMN**: Export the current process model as a BPMN 2.0 XML file.</div></div></li>
    <li><div className="flex flex-row gap-2 items-center"><Undo /><div>**Undo**: Undo the last action.</div></div></li>
    <li><div className="flex flex-row gap-2 items-center"><Redo /><div>**Redo**: Redo the last undone action.</div></div></li>
