...
export default function SingleChoiceTask({ task, description, choices, responsePath, flowElementInstanceId, userInputVariableName, userId }: Readonly<SingleChoiceTaskProps>) {
