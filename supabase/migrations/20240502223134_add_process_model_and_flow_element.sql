create table if not exists "public"."activity_element" (
...
create table if not exists "public"."flow_element" (
                                         "id" bigint generated by default as identity not null,
                                         "created_at" timestamp with time zone not null default now(),
...
CREATE UNIQUE INDEX if not exists activity_element_flow_element_id_key ON public.activity_element USING btree (flow_element_id);

CREATE UNIQUE INDEX if not exists activity_element_pkey ON public.activity_element USING btree (id);

CREATE UNIQUE INDEX if not exists flow_element_pkey ON public.flow_element USING btree (id);

CREATE UNIQUE INDEX if not exists process_model_pkey ON public.process_model USING btree (id);
